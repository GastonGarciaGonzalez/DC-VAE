...
from tensorflow.keras.layers import Layer, Input, Conv1D, Concatenate, Lambda, Cropping1D, Conv1DTranspose
...
class DCVAE:
    ...
    def __init__(self,
        ...
        # Hidden layers (1D Dilated Convolution)
        for i in range(len(cnn_units)):
            h_dec_cnn = Conv1DTranspose(cnn_units[i], kernel, activation='selu', use_bias=False,
                           strides=strs, padding="valid", 
        ...
        #opt = optimizers.SGD(learning_rate=self.__lr, momentum=0.9)
